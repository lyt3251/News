...
@interface NewsNoticesViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation NewsNoticesViewController
...
-(void)requestList
{
    ...
    @weakify(self);
    [newsManager requestGwtgListByPage:self.currentPage  onCompleted:^(NSURLSessionDataTask *task, id responseObject, NSError *error) {
        @strongify(self);
