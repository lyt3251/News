...
@property (nonatomic, strong) DAProgressOverlayView *vProgress;//进度提醒
...
-(void)setupViews
{
    ...
    [failedText setTextColor:[UIColor whiteColor]];
    [failedText setFont:[UIFont systemFontOfSize:13]];
...
//    CGFloat delWidth = _delImageView.image.size.width/2.0f;
    ...
    [_delImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(self.mas_right).with.offset(4);
        make.size.mas_equalTo(CGSizeMake(delWidth, delWidth));
    }];
    ...
    switch (newStatus) {
        ...
        case UPLOADIMAGE_STATUS_UPLOADING:
        {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                tmpObject.vProgress.progress = 0.0f;
            });
